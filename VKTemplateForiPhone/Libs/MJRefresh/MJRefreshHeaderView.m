...
@synthesize stringRefreshing,stringPulling,stringRelease;
...
- (void)setState:(RefreshState)state
{
    ...
    NSLog(@"header:%@",NSStringFromCGRect(_statusLabel.frame));
    
	switch (_state = state) {
		case RefreshStatePulling:
        {
            _statusLabel.text = stringRelease ? stringRelease : kReleaseToRefresh;
        ...
        {
            _statusLabel.text = stringPulling ? stringPulling : kPullToRefresh;
        ...
        {
            _statusLabel.text = stringRefreshing ?  stringRefreshing : kRefreshing;
