...
- (void)setState:(RefreshState)state
{
    ...
    NSLog(@"footer:%@",NSStringFromCGRect(_statusLabel.frame));
	switch (_state = state)
    {
		case RefreshStatePulling:
        {
            _statusLabel.text = self.stringRelease ?  self.stringRelease :kReleaseToRefresh;
        ...
        {
			_statusLabel.text = self.stringPulling ?  self.stringPulling :kPullToRefresh;
        ...
        {
            _statusLabel.text = self.stringRefreshing ?  self.stringRefreshing : kRefreshing;
...
- (void)setIsLastPage:(bool)isLastPage {
    ...
    if (isLastPage) {
        _statusLabel.text = kReacheTheEnd;
