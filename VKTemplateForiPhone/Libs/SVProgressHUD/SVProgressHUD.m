...
+ (void)showSuccessWithStatus:(NSString*)string durationTime:(float)duration {
...
+ (void)showErrorWithStatus:(NSString *)string durationTime:(float)duration {
...
+ (void)showImage:(UIImage *)image status:(NSString *)string {
    [[SVProgressHUD sharedView] showImage:image status:string duration:1.5f];
}
