//
//  FollowUpDetailViewController.m
//  VKTemplateForiPhone
//
...
@interface FollowUpDetailViewController ()<UIWebViewDelegate>{
     BOOL isLoadingFinished;
}
@end

@implementation FollowUpDetailViewController
...
- (void)viewDidLoad {
    ...
    labelTitle.text = [detailInfo objectForKey:@"visit_theme"];
    ...
    //第一次加载先隐藏webview
    [wView setHidden:YES];
    [wView loadHTMLString:OptimizeHtmlString([detailInfo objectForKey:@"visit_detail"]) baseURL:nil];
    wView.delegate = self;
...
- (void)webViewDidFinishLoad:(UIWebView *)webView
{
    ...
    //获取实际要显示的html
    NSString *html = [self htmlAdjustWithPageWidth:widthOfBody html:OptimizeHtmlString([detailInfo objectForKey:@"visit_detail"]) webView:webView];
    //设置为已经加载完成
