...
{
    self.headerView.frame = CGRectMake(0, 47, MainScreenWidth, self.buttonHeight);
...
{
    _mainScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, self.buttonHeight+10+47, MainScreenWidth, MainScreenHeight - self.buttonHeight)];
