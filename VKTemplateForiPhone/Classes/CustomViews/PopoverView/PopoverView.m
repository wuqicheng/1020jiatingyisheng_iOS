...
#define kDividerColor [UIColor whiteColor] //[UIColor colorWithRed:0.329 green:0.341 blue:0.353 alpha:0.15f]


// BACKGROUND GRADIENT

//bottom color white in gradient bg
#define kGradientBottomColor GetColorWithRGB(255, 37, 159)//[UIColor colorWithWhite:0.980f alpha:kBoxAlpha]

//top color white value in gradient bg
#define kGradientTopColor GetColorWithRGB(255, 37, 159)//[UIColor colorWithWhite:1.f alpha:kBoxAlpha]
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withViewArray:(NSArray *)viewArray {
    ...
    for(UIView *view in viewArray) {
        ...
        view.frame = CGRectMake(view.frame.origin.x, dy, view.frame.size.width, view.frame.size.height);
        dy = dy + view.frame.size.height + padding;
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withStringArray:(NSArray *)stringArray {
    ...
    for(NSString *string in stringArray) {
        ...
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 80.f, textSize.height)];//textSize.width
